...
typedef enum {
    ...
    SUIT_PARAMETER_SALT              = 100,
    SUIT_PARAMETER_EPHEMERAL_PUBLIC_KEY = 101,
    SUIT_PARAMETER_IV = 102
} suit_parameter_t;
/** @} */
...
typedef struct {
    ...
    suit_param_ref_t param_salt;
    suit_param_ref_t param_ephemeral_public_key;
    suit_param_ref_t param_iv;
    /**
