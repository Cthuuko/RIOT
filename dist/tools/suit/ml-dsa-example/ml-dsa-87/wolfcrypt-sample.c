/*
 * Minimal example: generate an ML-DSA-87 (FIPS 204 / NIST security
 * category 5) keypair, sign a message, and verify the signature using
...
/* ML-DSA-87 corresponds to NIST security category 5 in wolfCrypt's API */
#define ML_DSA_SECURITY_CATEGORY 5
...
int main(void)
{
    ...
    const char *message = "Post-quantum signatures with wolfCrypt ML-DSA-87";
    ...
    /* 3. Select ML-DSA-87 (NIST security category 5) */
    ...
    /* 5. Determine key/signature sizes for ML-DSA-87 and allocate buffers
     *    (expected: priv 4896, pub 2592, sig 4627 bytes) */
