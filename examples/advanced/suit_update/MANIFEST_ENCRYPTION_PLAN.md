...
- [ ] Step 2: device integration (decrypt hook in `sys/suit/transport/worker.c`, `suit_manifest_encrypt` pseudomodule, opt-out flag)
- [ ] Step 3: host tooling (`suit/encrypt` make target, device-key header generation)
- [ ] Step 4: buffer sizing (`SUIT_MANIFEST_BUFSIZE` + ~130 B)
- [ ] Step 5: E2E on native64, then samr21-xpro (see feasibility section)
- [ ] Step 6: documentation (NATIVE_SETUP.md, SAMR21_EXAMPLES.md, MANIFEST_ENCRYPTION_CHANGES.md, CLAUDE.md)
